...
namespace DijitalAjanda.Server.Migrations
{
    ...
    [Migration("20260104123412_AddHabitCompletedAt")]
    partial class AddHabitCompletedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DijitalAjanda.Server.Models.Badge", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DijitalAjanda.Server.Models.HabitEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DijitalAjanda.Server.Models.Note", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DijitalAjanda.Server.Models.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DijitalAjanda.Server.Models.UserBadge", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DijitalAjanda.Server.Models.JournalSentiment", b =>
                {
                    b.HasOne("DijitalAjanda.Server.Models.JournalEntry", "JournalEntry")
                        .WithOne("Sentiment")
                        .HasForeignKey("DijitalAjanda.Server.Models.JournalSentiment", "JournalEntryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DijitalAjanda.Server.Models.TaskItem", b =>
                {
                    ...
                    b.HasOne("DijitalAjanda.Server.Models.Project", "Project")
                        .WithMany()
            ...
            modelBuilder.Entity("DijitalAjanda.Server.Models.UserBadge", b =>
                {
                    b.HasOne("DijitalAjanda.Server.Models.Badge", "Badge")
                        .WithMany()
